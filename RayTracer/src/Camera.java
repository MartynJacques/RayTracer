public class Camera {
	...
	public Camera(Vec3 lookfrom, Vec3 lookat, Vec3 vup, double hfov, double aspect, double aperture,
		...
		origin = lookfrom;
		w = Vec3.unitVector(lookfrom.sub(lookat)); // vector pointing out of camera
		u = Vec3.unitVector(Vec3.cross(vup, w)); // vector pointing out of side of camera, orthogonal to both view and
													// up direction
